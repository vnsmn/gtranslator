...
public class H2Service implements Configurable {
    ...
    private void dropDb() throws SQLException {
        ...
        String dropTableQuery = "DROP TABLE SOUND";
        String dropIndexQuery = "DROP INDEX IDX_SOUND_ENG_LABEL";
        try {
            connection.setAutoCommit(false);

            createPreparedStatement = connection
                    .prepareStatement(dropTableQuery);
            createPreparedStatement.executeUpdate();
            createPreparedStatement.close();

            createPreparedStatement = connection
                    .prepareStatement(dropIndexQuery);
            createPreparedStatement.executeUpdate();
            createPreparedStatement.close();
    ...
    private void initHibernate(String urlConnect) throws IOException {
        ...
        cfg.addAnnotatedClass(OxfordEntity.class);
